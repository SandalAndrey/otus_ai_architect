...
| FR-2.9 | Маршрутизация по классу вопроса        | Супервизор должен относить вопрос к одному из двух классов и вести простые вопросы коротким путём, без обхода графа и без сверки. Класс, число вызовов модели и время каждого шага пишутся в трассу. Требование существует ради NFR-1.2: полный путь для всех запросов в бюджет латентности не укладывается. | Must (Критично)    |
